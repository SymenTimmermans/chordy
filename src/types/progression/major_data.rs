...
/// Supports 61 different chord variants.
pub fn get_node(name: &str) -> Option<&'static RomanChord> {
    match name {
        ...
        "VI9" => Some(&VI_9),
        "VIb9" => Some(&VI_FLAT_9),
        "sIdim7" => Some(&MINOR_SIDIM7),
        "sIVm7b5" => Some(&MINOR_SIVM7FLAT_5),
        "II7" => Some(&II_7),
        "II9" => Some(&II_9),
        "IIb9" => Some(&II_FLAT_9),
        "VIm7b5/b3" => Some(&MINOR_VIM7FLAT_5_SLASH_FLAT_3),
        "sIIdim7" => Some(&MINOR_SIIDIM7),
        "VII7" => Some(&VII_7),
        "VII9" => Some(&VII_9),
        "VIIb9" => Some(&VII_FLAT_9),
        "v7" => Some(&MINOR_V_7),
        "I79" => Some(&I7_9),
        "I7b9" => Some(&I7_FLAT_9),
        "IIIm7b5" => Some(&MINOR_IIIM7FLAT_5),
        "Im6" => Some(&MINOR_IM6),
        "V/2" => Some(&V_SLASH_2),
        "bVII9" => Some(&MINOR_FLAT_VII_9),
        "bVII9" => Some(&MINOR_FLAT_VII9),
        "bVI" => Some(&MINOR_FLAT_VI),
        "bII7" => Some(&MINOR_FLAT_II7),
        "IVm7" => Some(&MINOR_IVM7),
        "bVI7" => Some(&MINOR_FLAT_VI7),
        "Idim/b3" => Some(&MINOR_IDIM_SLASH_FLAT_3),
        "III7" => Some(&III_7),
        "III9" => Some(&III_9),
        "IIIb9" => Some(&III_FLAT_9),
        "VIIm7b5" => Some(&MINOR_VIIM7FLAT_5),
        "sVdim7" => Some(&MINOR_SVDIM7),
        _ => None,
    }
}
