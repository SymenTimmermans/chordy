...
pub use renderer::{ChordFormat, ChordRenderer, NamingConvention};
pub use types::*;
...
mod tests {
    ...
    fn test_chord_name_creation() {
        let chord_name = ChordName::new(ChordRoot::Note(note!("C")), crate::ChordQuality::Major);
    ...
    fn test_renderer_formats() {
        let chord_name = ChordName::new(ChordRoot::Note(note!("C")), crate::ChordQuality::Minor)
