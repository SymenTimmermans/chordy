...
impl<'a> IntervalChecker<'a> {
    ...
    pub fn has_major_third(&self) -> bool {
        self.has(Interval::MAJOR_THIRD)
    }
    pub fn has_minor_third(&self) -> bool {
        self.has(Interval::MINOR_THIRD)
    }
    pub fn has_any_third(&self) -> bool {
        self.has_major_third() || self.has_minor_third()
    }

    pub fn has_perfect_fifth(&self) -> bool {
        self.has(Interval::PERFECT_FIFTH)
    }
    pub fn has_diminished_fifth(&self) -> bool {
        self.has(Interval::DIMINISHED_FIFTH)
    }
    pub fn has_augmented_fifth(&self) -> bool {
        self.has(Interval::AUGMENTED_FIFTH)
    }

    pub fn has_minor_seventh(&self) -> bool {
        self.has(Interval::MINOR_SEVENTH)
    }
    pub fn has_major_seventh(&self) -> bool {
        self.has(Interval::MAJOR_SEVENTH)
    }
    pub fn has_diminished_seventh(&self) -> bool {
        self.has(Interval::DIMINISHED_SEVENTH)
    }
    pub fn has_any_seventh(&self) -> bool {
        self.has_minor_seventh() || self.has_major_seventh()
    }

    pub fn has_major_second(&self) -> bool {
        self.has(Interval::MAJOR_SECOND)
    }
    pub fn has_major_ninth(&self) -> bool {
        self.has(Interval::MAJOR_NINTH)
    }
    ...
    pub fn has_natural_ninth(&self) -> bool {
        self.has_major_second() || self.has_major_ninth()
    }
    pub fn has_minor_ninth(&self) -> bool {
        self.has(Interval::MINOR_NINTH)
    }
    pub fn has_augmented_ninth(&self) -> bool {
        self.has(Interval::AUGMENTED_NINTH)
    }

    pub fn has_perfect_fourth(&self) -> bool {
        self.has(Interval::PERFECT_FOURTH)
    }
    pub fn has_perfect_eleventh(&self) -> bool {
        self.has(Interval::PERFECT_ELEVENTH)
    }
    ...
    /// in chord voicings.
    pub fn has_natural_eleventh(&self) -> bool {
        self.has_perfect_eleventh()
    }
    pub fn has_augmented_eleventh(&self) -> bool {
        self.has(Interval::AUGMENTED_ELEVENTH)
    }
    pub fn has_any_eleventh(&self) -> bool {
        self.has_perfect_fourth() || self.has_perfect_eleventh()
    }

    pub fn has_major_sixth(&self) -> bool {
        self.has(Interval::MAJOR_SIXTH)
    }
    pub fn has_major_thirteenth(&self) -> bool {
        self.has(Interval::MAJOR_THIRTEENTH)
    }
    ...
    pub fn has_natural_thirteenth(&self) -> bool {
        self.has_major_thirteenth()
    }
    pub fn has_minor_thirteenth(&self) -> bool {
        self.has(Interval::MINOR_THIRTEENTH)
    }
    pub fn has_augmented_thirteenth(&self) -> bool {
        self.has(Interval::AUGMENTED_THIRTEENTH)
    }
...
impl ChordAnalyzer {
    ...
    fn analyze_added_tones(intervals: &[Interval]) -> Vec<AddedTone> {
        ...
        if interval_checker.has_natural_ninth()
            && interval_checker.has_any_third()
            && !interval_checker.has_any_seventh()
        {
        ...
        if interval_checker.has_perfect_fourth()
            && interval_checker.has_any_third()
            && !interval_checker.has_any_seventh()
        {
        ...
        if interval_checker.has_perfect_eleventh()
            && interval_checker.has_any_third()
            && !interval_checker.has_natural_ninth()
        {
    ...
    fn analyze_omissions(intervals: &[Interval], chord_name: &ChordName) -> Vec<Omission> {
        ...
        if chord_name.extensions.contains(&Extension::Thirteenth)
            && !interval_checker.has_any_eleventh()
        {
