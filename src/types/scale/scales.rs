...
pub const IONIAN_SHARP_5: ScaleDefinition = ScaleDefinition {
    name: "Ionian Sharp 5",
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MAJOR_THIRD, Interval::PERFECT_FOURTH, Interval::AUGMENTED_FIFTH, Interval::MAJOR_SIXTH, Interval::MAJOR_SEVENTH],
...
pub const DORIAN_ALTERED: ScaleDefinition = ScaleDefinition {
    name: "Dorian Altered",
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MINOR_THIRD, Interval::AUGMENTED_FOURTH, Interval::PERFECT_FIFTH, Interval::MAJOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const DORIAN_FLAT_2: ScaleDefinition = ScaleDefinition {
    name: "Dorian Flat 2",
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_SECOND, Interval::MINOR_THIRD, Interval::PERFECT_FOURTH, Interval::PERFECT_FIFTH, Interval::MAJOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const PHRYGIAN_DOMINANT: ScaleDefinition = ScaleDefinition {
    ...
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_SECOND, Interval::MAJOR_THIRD, Interval::PERFECT_FOURTH, Interval::PERFECT_FIFTH, Interval::MINOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const LYDIAN_SHARP_2: ScaleDefinition = ScaleDefinition {
    name: "Lydian Sharp 2",
    intervals: &[Interval::PERFECT_UNISON, Interval::AUGMENTED_SECOND, Interval::MAJOR_THIRD, Interval::AUGMENTED_FOURTH, Interval::PERFECT_FIFTH, Interval::MAJOR_SIXTH, Interval::MAJOR_SEVENTH],
...
pub const LYDIAN_AUGMENTED: ScaleDefinition = ScaleDefinition {
    ...
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MAJOR_THIRD, Interval::AUGMENTED_FOURTH, Interval::AUGMENTED_FIFTH, Interval::MAJOR_SIXTH, Interval::MAJOR_SEVENTH],
...
pub const LYDIAN_DOMINANT: ScaleDefinition = ScaleDefinition {
    ...
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MAJOR_THIRD, Interval::AUGMENTED_FOURTH, Interval::PERFECT_FIFTH, Interval::MAJOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const MIXOLYDIAN_FLAT_6: ScaleDefinition = ScaleDefinition {
    ...
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MAJOR_THIRD, Interval::PERFECT_FOURTH, Interval::PERFECT_FIFTH, Interval::MINOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const LOCRIAN_NATURAL_2: ScaleDefinition = ScaleDefinition {
    ...
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MINOR_THIRD, Interval::PERFECT_FOURTH, Interval::DIMINISHED_FIFTH, Interval::MINOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const LOCRIAN_NATURAL_6: ScaleDefinition = ScaleDefinition {
    ...
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_SECOND, Interval::MINOR_THIRD, Interval::PERFECT_FOURTH, Interval::DIMINISHED_FIFTH, Interval::MAJOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const SUPER_LOCRIAN: ScaleDefinition = ScaleDefinition {
    name: "Super Locrian",
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_SECOND, Interval::MINOR_THIRD, Interval::MAJOR_THIRD, Interval::DIMINISHED_FIFTH, Interval::MINOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const ULTRALOCRIAN: ScaleDefinition = ScaleDefinition {
    name: "Ultralocrian",
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_SECOND, Interval::MINOR_THIRD, Interval::DIMINISHED_FOURTH, Interval::DIMINISHED_FIFTH, Interval::MINOR_SIXTH, Interval::DIMINISHED_SEVENTH],
...
pub const AUGMENTED: ScaleDefinition = ScaleDefinition {
    name: "Augmented",
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_THIRD, Interval::MAJOR_THIRD, Interval::PERFECT_FIFTH, Interval::AUGMENTED_FIFTH, Interval::MAJOR_SEVENTH],
...
pub const BEBOP_DOMINANT: ScaleDefinition = ScaleDefinition {
    name: "Bebop Dominant",
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MAJOR_THIRD, Interval::PERFECT_FOURTH, Interval::PERFECT_FIFTH, Interval::MAJOR_SIXTH, Interval::MINOR_SEVENTH, Interval::MAJOR_SEVENTH],
...
pub const BLUES: ScaleDefinition = ScaleDefinition {
    name: "Blues",
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_THIRD, Interval::PERFECT_FOURTH, Interval::DIMINISHED_FIFTH, Interval::PERFECT_FIFTH, Interval::MINOR_SEVENTH],
...
pub const DOUBLE_HARMONIC: ScaleDefinition = ScaleDefinition {
    ...
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_SECOND, Interval::MAJOR_THIRD, Interval::PERFECT_FOURTH, Interval::PERFECT_FIFTH, Interval::MINOR_SIXTH, Interval::MAJOR_SEVENTH],
...
pub const ENIGMATIC: ScaleDefinition = ScaleDefinition {
    name: "Enigmatic",
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_SECOND, Interval::MAJOR_THIRD, Interval::AUGMENTED_FOURTH, Interval::AUGMENTED_FIFTH, Interval::AUGMENTED_SIXTH, Interval::MAJOR_SEVENTH],
...
pub const GYPSY: ScaleDefinition = ScaleDefinition {
    name: "Gypsy",
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MINOR_THIRD, Interval::AUGMENTED_FOURTH, Interval::PERFECT_FIFTH, Interval::MINOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const HARMONIC_MAJOR: ScaleDefinition = ScaleDefinition {
    name: "Harmonic Major",
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MAJOR_THIRD, Interval::PERFECT_FOURTH, Interval::PERFECT_FIFTH, Interval::MINOR_SIXTH, Interval::MAJOR_SEVENTH],
...
pub const HUNGARIAN_MAJOR: ScaleDefinition = ScaleDefinition {
    ...
    intervals: &[Interval::PERFECT_UNISON, Interval::AUGMENTED_SECOND, Interval::MAJOR_THIRD, Interval::AUGMENTED_FOURTH, Interval::PERFECT_FIFTH, Interval::MAJOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const MAJOR_BEBOP: ScaleDefinition = ScaleDefinition {
    name: "Major Bebop",
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MAJOR_THIRD, Interval::PERFECT_FOURTH, Interval::PERFECT_FIFTH, Interval::AUGMENTED_FIFTH, Interval::MAJOR_SIXTH, Interval::MAJOR_SEVENTH],
...
pub const MAJOR_LOCRIAN: ScaleDefinition = ScaleDefinition {
    name: "Major Locrian",
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MAJOR_THIRD, Interval::PERFECT_FOURTH, Interval::DIMINISHED_FIFTH, Interval::MINOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const MAJOR_PENTATONIC: ScaleDefinition = ScaleDefinition {
    ...
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MAJOR_THIRD, Interval::PERFECT_FIFTH, Interval::MAJOR_SIXTH],
...
pub const NEAPOLITAN_MAJOR: ScaleDefinition = ScaleDefinition {
    ...
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_SECOND, Interval::MINOR_THIRD, Interval::PERFECT_FOURTH, Interval::PERFECT_FIFTH, Interval::MAJOR_SIXTH, Interval::MAJOR_SEVENTH],
...
pub const NEAPOLITAN_MINOR: ScaleDefinition = ScaleDefinition {
    ...
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_SECOND, Interval::MINOR_THIRD, Interval::PERFECT_FOURTH, Interval::PERFECT_FIFTH, Interval::MINOR_SIXTH, Interval::MAJOR_SEVENTH],
...
pub const OCTATONIC_1: ScaleDefinition = ScaleDefinition {
    name: "Octatonic 1",
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MINOR_THIRD, Interval::PERFECT_FOURTH, Interval::DIMINISHED_FIFTH, Interval::MINOR_SIXTH, Interval::MAJOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const OCTATONIC_2: ScaleDefinition = ScaleDefinition {
    name: "Octatonic 2",
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_SECOND, Interval::MINOR_THIRD, Interval::MAJOR_THIRD, Interval::AUGMENTED_FOURTH, Interval::PERFECT_FIFTH, Interval::MAJOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const PERSIAN: ScaleDefinition = ScaleDefinition {
    name: "Persian",
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_SECOND, Interval::MAJOR_THIRD, Interval::PERFECT_FOURTH, Interval::DIMINISHED_FIFTH, Interval::MINOR_SIXTH, Interval::MAJOR_SEVENTH],
...
pub const PROMETHEUS: ScaleDefinition = ScaleDefinition {
    name: "Prometheus",
    intervals: &[Interval::PERFECT_UNISON, Interval::MAJOR_SECOND, Interval::MAJOR_THIRD, Interval::AUGMENTED_FOURTH, Interval::MAJOR_SIXTH, Interval::MINOR_SEVENTH],
...
pub const TRITONE: ScaleDefinition = ScaleDefinition {
    name: "Tritone",
    intervals: &[Interval::PERFECT_UNISON, Interval::MINOR_SECOND, Interval::MAJOR_THIRD, Interval::DIMINISHED_FIFTH, Interval::PERFECT_FIFTH, Interval::MINOR_SEVENTH],
