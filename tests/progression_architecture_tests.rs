...
fn test_progression_options_basic() {
    ...
    let options = c_major.progression_options(&c_chord);
...
fn test_key_integration_with_new_architecture() {
    ...
    let progression_options = c_major.progression_options(&c_chord);
    assert!(progression_options.is_some());
...
fn test_chord_copy_semantics_in_progressions() {
    ...
    let options1 = c_major.progression_options(&chord_copy1);
    let options2 = c_major.progression_options(&chord_copy2);
