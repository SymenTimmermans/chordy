...
use chordy::types::{IntervalSet, Interval, Chord, RomanChord, RomanNumeral, RomanDegree, Accidental, NoteName, Letter, Scale};
...
fn test_interval_set_from_slice() {
    let array = [Interval::PERFECT_UNISON, Interval::MAJOR_THIRD, Interval::PERFECT_FIFTH];
...
fn test_interval_set_const_from_array() {
    const MAJOR_TRIAD: IntervalSet = IntervalSet::const_from_array([
        ...
        Interval::PERFECT_UNISON, Interval::PERFECT_UNISON, Interval::PERFECT_UNISON,
        Interval::PERFECT_UNISON, Interval::PERFECT_UNISON, Interval::PERFECT_UNISON,
        Interval::PERFECT_UNISON
    ], 3);
